...
// })
// // app.get('/wetech',(req,res)=>{
// //     const filepath = path.resolve(__dirname,'./public/wetech/index.html');
// //     console.log("inside wetech");
// //     res.sendFile(filepath)
// // })
...
//     return res.status(400).send(`The stream named ${stream} already exists.`);
//   }
//     if(stream){
...
//       <img style="height:40px; width:150px; justify-content: center;" src="../images/logo-light.png">
//       <img style="height:24px; width:24px; justify-content: center;" src="./images/x.png">
//       <img style="height: 43.3px; width:122px; justify-content: center;" src="./images/logo-wetech.png">
...
// //   const username = req.params.username;
// //   const filepath = path.resolve(__dirname, `./public/${username}/index.html`);
// //   // Increment the visit count for this stream
// //   visits[username] = (visits[username] || 0) + 1;
// //   console.log(`${username} has been visited ${visits[username]} times.`);
...
// //       // Insert the visit count into the h1 element
// //       const visitCount = visits[username];
// //       console.log(visitCount)
// //       const modifiedContent = data.replace(
// //         /<h1 id="caption-header" class="caption-header" style="font-size: 24px; justify-content: center;">Event Live Captioning for ([^<]+)<\/h1>/,
// //         `<h1 id="caption-header" class="caption-header" style="font-size: 24px; justify-content: center;">Event Live Captioning for $1 - Visited: ${visitCount} times</h1>`
// //       );
...
// //     res.status(404).send('The requested stream does not exist.');
// //   }
// // });
